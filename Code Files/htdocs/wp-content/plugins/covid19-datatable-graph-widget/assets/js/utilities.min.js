...
(global = global || self, global.Btncov = factory());
}(this, function () { 'use strict';

var shared, worker, Btncov = {};
...
try {
	Btncov.debug.ESM = false; // mark build as ES module
	Btncov.debug.SHA = 'f0e7cf665ee5bfbc46bfffb6b64474f2caee7de0';
	if (false === true && typeof window === 'object') {
	    window.Btncov = Btncov;
	}
} catch(e) {}
